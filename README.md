...
To run this app locally, run 'npm install' and then 'node web.js'. To see the app running life visit [personal-heatmap.herokuapp.com](http://personal-heatmap.herokuapp.com/).
